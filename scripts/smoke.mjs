...
assertFileContains('docs/KanbanRPM Manual.md', ['Project', 'Subproject', 'Pull Daily', 'Weekly review']);
assertFileContains('docs/KanbanRPM Manual ko.md', ['Project', 'Subproject', 'Pull Daily', 'Weekly review']);
