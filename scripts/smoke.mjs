...
assertFileContains('docs/KanbanRPM Manual.md', ['Project', 'Subproject', 'Pull Daily', 'Weekly review', 'Table', 'List', 'Timeline']);
assertFileContains('docs/KanbanRPM Manual ko.md', ['Project', 'Subproject', 'Pull Daily', 'Weekly review', 'Table', 'List', 'Timeline']);
