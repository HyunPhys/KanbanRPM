...
assertFileContains('docs/KanbanRPM Manual.md', ['Project', 'Subproject', 'Subproject filter', 'primary_project', 'Table', 'List', 'Timeline']);
assertFileContains('docs/KanbanRPM Manual ko.md', ['Project', 'Subproject', 'Subproject', 'primary_project', 'Table', 'List', 'Timeline']);
